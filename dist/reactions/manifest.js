...
exports.ReactionsManifest = void 0;
exports.ReactionsManifest = {
    name: 'reactions',
    version: '0.1.0',
    envVars: {
        REACTION_MAX_HISTORY: {
            required: false,
            default: '50',
            description: 'Max reactions retained per channel in the per-channel LRU history. ' +
                'Older entries are shifted out when the buffer overflows.',
        },
        REACTION_MAX_CHANNEL_NAME_LENGTH: {
            required: false,
            default: '50',
            description: 'Hard cap on channel name length accepted by handleSubscribeToReactions. ' +
                'Mirrors the gateway-wide MAX_CHANNEL_NAME_LENGTH default.',
        },
        REACTION_AVAILABLE_OVERRIDE: {
            required: false,
            description: 'Optional JSON object overriding the built-in 12-emoji catalog ' +
