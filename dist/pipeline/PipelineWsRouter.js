...
exports.PipelineWsRouter = void 0;
...
class PipelineWsRouter {
     ...
     */
    async emitEvent(channel, eventType, payload, envelope) {
        ...
        if (this.messageRouter) {
            try {
                ...
                this.logger.error(`[pipeline] Failed to broadcast event to ${channel}:`, err && err.message ? err.message : err);
            }
        }
        else {
    ...
    _isValidChannel(channel) {
        ...
        if (channel.length === 0 || channel.length > this.maxChannelLength)
            return false;
        if (channel === CHANNEL_ALL || channel === CHANNEL_APPROVALS)
            return true;
...
exports.PipelineWsRouter = PipelineWsRouter;
exports.default = PipelineWsRouter;
//# sourceMappingURL=PipelineWsRouter.js.map