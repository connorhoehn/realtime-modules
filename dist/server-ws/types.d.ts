...
export interface WsService {
    handleAction(clientId: string, action: string, data: Record<string, unknown>): Promise<void> | void;
 ...
 * with 401.
 */
export type WsAuthFn = (req: IncomingMessage) => Promise<WsAuthContext> | WsAuthContext;
