...
export type DocumentCallMetaPatch = Partial<Pick<DocumentCallMeta, 'title' | 'documentIds' | 'documentTitles' | 'hostUserId' | 'media'>>;
/**
...
export declare function isParticipantStateBroadcast(p: unknown): p is ParticipantStateBroadcast;
/**
...
export interface CallMessageRouter {
    getClientsByUserId?(userIds: string[], excludeClientId: string): UserClientMatch[] | Promise<UserClientMatch[]>;
...
export interface CallConfig {
     ...
     */
    canCall?: (callerId: string, targetUserIds: string[]) => boolean | Promise<boolean>;
    /**
...
export type CallWithSpan = <T>(name: string, attrs: Record<string, string | number | boolean>, fn: (span: {
...
export declare const ALLOWED_CALL_ACTIONS: ReadonlySet<CallAction>;
