 ...
 */
export const DEFAULT_SUPPORTED_MODES: Readonly<Record<string, CursorModeConfig>> = Object.freeze({
    freeform: {
...
export const DEFAULT_THROTTLE_INTERVAL_MS = 250;
export const DEFAULT_CURSOR_TTL_MS = 30000;
