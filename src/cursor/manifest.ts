...
export const CursorManifest: FeatureManifest = {
    name: 'cursor',
    version: '0.1.0',
    channels: ['cursor:*'],
    envVars: {
        CURSOR_THROTTLE_INTERVAL_MS: {
            ...
            default: '250',
            description:
                'Minimum interval (ms) between accepted cursor updates per client. ' +
        ...
        CURSOR_TTL_MS: {
            ...
            default: '30000',
            description:
                'Cursor TTL (ms). Cursors whose latest timestamp is older than this ' +
