...
export const PresenceManifest: FeatureManifest = {
    name: 'presence',
    version: '0.1.0',
    channels: ['presence:*'],
    envVars: {
        PRESENCE_HEARTBEAT_INTERVAL_MS: {
            ...
            default: '30000',
            description:
                'How often (ms) the stale-presence sweep runs. Lower for tighter timeout granularity at the cost of CPU.',
        },
        PRESENCE_TIMEOUT_MS: {
            required: false,
            default: '60000',
            description:
                'Inactivity threshold (ms) after which a client is auto-flipped to status:offline.',
        },
        PRESENCE_STALE_THRESHOLD_MS: {
            required: false,
            default: '90000',
            description:
                'Idle-client eviction TTL (ms). cleanupStaleClients deletes presence entries past this age.',
        },
        ...
        PRESENCE_DISCONNECT_DELAY_MS: {
            ...
            default: '5000',
            description:
                'Grace period (ms) after disconnect before client state is purged — allows for reconnects.',
        },
        ...
        PRESENCE_MAX_METADATA_SIZE: {
            ...
            default: '4096',
            description:
                'Max serialized size (bytes) of presence.metadata; oversize payloads are replaced with a stub.',
        },
    },
    dependencies: [],
};
