...
export const agentStreamingManifest: FeatureManifest = {
    ...
    envVars: {
        AGENT_STREAM_HEARTBEAT_MS: {
            ...
            default: '25000',
            description:
                'SSE heartbeat interval in milliseconds. Lower to keep aggressive proxies alive.',
        },
    },
    channels: [],
    ...
    install: {
        backendRoutes:
            '@connorhoehn/realtime-modules/agent-streaming (agentStreamMiddleware)',
