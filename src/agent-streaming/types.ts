...
export interface AgentStream {
  ...
  // Tool calls — note the EXACT field names enforced by signature.
  toolCallStart(
    toolCallId: string,
    toolCallName: string,
    parentMessageId?: string,
