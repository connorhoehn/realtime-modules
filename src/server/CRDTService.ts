        ...
        try {
            ...
            switch (action) {
                ...
                case 'listDocuments': {
                    ...
                    const lister = (this.messageRouter.getClientData?.(clientId) as any)?.userContext;
                    if (lister?.userId) await this.metadataService.backfillOwnerNames(docs, { userId: lister.userId, displayName: lister.displayName || lister.email || null });
