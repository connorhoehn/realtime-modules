...
let current: Required<MediaEffectsAssets> = {
  wasmBase: DEFAULT_WASM_BASE,
  segmenterModelUrl: DEFAULT_SEGMENTER_MODEL_URL,
  faceLandmarkerModelUrl: DEFAULT_FACE_LANDMARKER_MODEL_URL,
};
...
export function setMediaEffectsAssets(assets: MediaEffectsAssets): void {
  current = { ...current, ...assets };
}

export function getMediaEffectsAssets(): Required<MediaEffectsAssets> {
  return current;
}
